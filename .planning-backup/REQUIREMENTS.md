...
- [x] **SEO-01**: GA4 property creata automaticamente per ogni nuovo progetto via Google Analytics Admin API
- [x] **SEO-02**: Dominio verificato su GSC e sitemap.xml submessa automaticamente al deploy
- [x] **SEO-03**: Worker Cron settimanale controlla posizioni SERP via Serper.dev per ogni progetto
- [x] **SEO-04**: Alert Telegram automatico quando una keyword scende >3 posizioni
