...
- **Global scope**: `/home/soliwkr/Work/Codice/rankempire-italia/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/soliwkr/Work/Codice/rankempire-italia/.gemini/notes/`)
...
2. Glob `/home/soliwkr/Work/Codice/rankempire-italia/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/home/soliwkr/Work/Codice/rankempire-italia/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/soliwkr/Work/Codice/rankempire-italia/.gemini/notes/` — works in any directory
