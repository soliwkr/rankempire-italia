...
```
Task(
  prompt="Read /home/soliwkr/Work/Codice/rankempire-italia/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/soliwkr/Work/Codice/rankempire-italia/.gemini/get-shit-done/templates/VALIDATION.md`
