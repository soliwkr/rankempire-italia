...
INSTALL_JS_GLOBAL="/home/soliwkr/Work/Codice/rankempire-italia/.gemini/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/soliwkr/Work/Codice/rankempire-italia/.gemini/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
